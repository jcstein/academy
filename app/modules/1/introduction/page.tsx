...
export default function Page() {
  ...
  return (
    <div className="space-y-2">
      ...
      <p className="pb-4">Welcome to the world of rollups! If you're an Ethereum Virtual Machine (EVM) developer, you might wonder how building on a rollup, like <CustomLink href="https://raas.gelato.network/rollups/details/public/op-celestia-testnet">OP Celestia Raspberry testnet</CustomLink>, compares to traditional blockchains. The truth is, the experience is designed to be seamless.</p>
      ...
      <h1 className="text-2xl pb-2">Building on Raspberry testnet</h1>
      <p className="pb-4">The Raspberry testnet is a rollup that operates with the familiarity of the EVM, making it an ideal playground for developers looking to explore the benefits of rollups without straying too far from the Ethereum development environment they know and love.</p>
      ...
      <p className="pb-2">Building on a rollup like the Raspberry testnet offers a familiar yet enhanced development experience for EVM developers. By following this tutorial, you'll learn how to deploy ERC-721 smart contract and integrate a VRF solution, all while enjoying the benefits of rollup technology.</p>
