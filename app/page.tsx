...
export default function Index() {
  return (
    <div className="space-y-2">
      ...
      <p className="pb-10">From smart contracts to building customized rollups, at your own pace, Modular Academy will show you how to build whatever with Celestia underneath.</p>
      ...
      <div className="pb-10">
        <CustomLink href="/modules/1/introduction" className="px-4 py-2 bg-purple-600 text-white font-bold rounded hover:bg-purple-700 transition duration-300 ease-in-out">
          Module 1
        </CustomLink>
      </div>
